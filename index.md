...
- **Software development** - Creating tools and pipelines (Python, Snakemake, Rust, R, Docker, Git, ImageJ Macro)

## 📚 Featured Publication

### [Shiba: a versatile computational method for systematic identification of differential RNA splicing across platforms](https://academic.oup.com/nar/article/53/4/gkaf098/8042001)

**Naoto Kubota**, Liang Chen, Sika Zheng
*Nucleic Acids Research* 53(4), 2025, gkaf098

<div style="margin: 2rem 0; text-align: center;">
  <img src="/assets/images/Fig_Kubota2025_1.png" alt="Shiba research figure" style="width: 100%; max-width: 800px; border-radius: 12px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1);">
</div>
...
*Feel free to explore my research, connect with me on social media, or reach out by [email](mailto:naotok@ucr.edu)!*
